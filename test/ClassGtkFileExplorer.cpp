...
void on_dialog_response(GtkDialog* dialog, gint response_id, gpointer user_data) {
    ...
    if (response_id == GTK_RESPONSE_ACCEPT) {
        ...
        GtkFileExplorer::setFile(selectedFile);
...
int main() {
    ...
    g_signal_connect(filechooserdialog, "response", G_CALLBACK(on_dialog_response), NULL);
    ...
    selectedFile = GtkFileExplorer::getFile();
